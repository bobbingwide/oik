...
* Changed: Updated PHPUnit tests for WordPress 5.8,[github bobbingwide oik issues 178] 
...
= 4.2.0 = 
* Changed: Further update tests for WordPress 5.7 compatibility,[github bobbingwide oik issues 173]
* Changed: Add support for post meta fields to be included in the REST API,[github bobbingwide oik issues 174]
...
= 4.1.3 = 
* Changed: Update tests for WordPress 5.7 compatibility,[github bobbingwide oik issues 173]
* Changed: Update tests for WordPress 5.6 compatibility,[github bobbingwide oik issues 169]
* Changed: Update for PHP 8.0,[github bobbingwide oik issues 172]
...
= 4.1.2 =
* Changed: Add support to autoload shared library classes,[github bobbingwide oik issues 172]
* Changed: Update more translatable strings used in shared libraries,[github bobbingwide oik issues 171]
* Tested: With WordPress 5.6 and WordPress Multi Site
...
= 4.1.1 =
* Changed: Add theme functions for post_date and post_modified,[github bobbingwide oik issues 170]
* Changed: Change code and tests for new oik-i18n logic and update language files,[github bobbingwide oik issues 171]
* Changed: bw_current_post_id for compatibility with Full Site Editing
* Changed: update test cases for jQuery 3.5.1 in WordPress 5.6,[github bobbingwide oik issues 169]
* Fixed: Ensure bw_format_sep is available by loading the bw_fields library,[github bobbingwide oik issues 165]
* Fixed: Prevent infinite recursion processing post_content in [bw_pages],[github bobbingwide oik issues 166]
* Fixed: Replace BW::e with e in bw_directions__example,[github bobbingwide oik issues 164]
...
= 4.1.0 = 
* Changed: In bw_attachments ensure id parameter isn't being passed as null,[github bobbingwide oik-blocks issues 34]
* Fixed: Avoid notices and warnings after updating translations,[github bobbingwide oik issues 147]
* Fixed: Don't call oik__help,[github bobbingwide oik issues 148]
* Changed: Improve bw_attachment for Dynamic content block,[github bobbingwide oik issues 149]
* Changed: Improve bw_register_custom_category to default to using hierarchical permalinks,[github bobbingwide oik issues 150]
* Fixed: Correct HTML end tag error in syntax for [bw_parent],[github bobbingwide oik issues 151]
* Changed: No longer set img max-width 100%,[github bobbingwide oik issues 152]
* Changed: Update tests to reflect change in sequence of parameters for bw_jq,[github bobbingwide oik issues 153]
* Changed: Update jQuery files for fancybox,[github bobbingwide oik issues 154]
* Changed: Update jquery cycle.all and CSS,[github bobbingwide oik issues 155]
* Changed: Update tests for WordPress 5.5 and PHP 7.4,[github bobbingwide oik issues 156]
* Changed: Add support to embed from local WordPress installs,[github bobbingwide oik issues 158]
* Changed: Update [bw_logo] shortcode for jQuery 3.5.1 compatibility. No longer use JavaScript,[github bobbingwide oik issues 159]
* Changed: Update PHPUnit expected results to reflect changes in WordPress 5.5.1-RC1,[github bobbingwide oik issues 160]
* Changed: Update bw_jquery_enqueue_script to better support SCRIPT_DEBUG and minimised files,[github bobbingwide oik issues 161]
* Fixed: Correct type for until attribute of oik/countdown,[github bobbingwide oik issues 162]
...
* Deleted: Forget about bwtroff and bwtron shortcodes,[github bobbingwide oik issues 105]
* Fixed: Ensure Class OIK_Autoload does not exist is traced as BW_TRACE_ERROR,[github bobbingwide oik issues 106]
* Changed: Adjust tests to cater for WordPress 5.3 changes,[github bobbingwide oik issues 130]
* Fixed: bw_link /permalink should use the same scheme as current content,[github bobbingwide oik issues 133]
* Changed: Allow styling of the bw_count shortcode,[github bobbingwide oik issues 134]
* Changed: Update tests for PHPUnit 8,[github bobbingwide oik issues 135]
* Changed: Use self::bw_retrieve_result to obtain error information for bw_remote_geth and bw_remote_get,[github bobbingwide oik issues 136]
* Changed: Implement oik-shortcodes shared library,[github bobbingwide oik issues 137]
* Changed: oik-bob-bing-wide needs bw_array_get_from in the bobbfunc shared library,[github bobbingwide oik issues 137]
* Added: Deliver blocks that were developed in oik-blocks,[github bobbingwide oik issues 138]
* Added: Generic shortcode block,[github bobbingwide oik issues 139]
* Fixed: Changed Google Maps API key in PHPUnit tests,[github bobbingwide oik issues 140]
...
* Changed: Wrapped some more LSB's in a span. Belt and braces., [github bobbingwide oik issue 115]
* Changed: Attempt to improve performance for Parent Page pull down for hierarchical post types, [github bobbingwide oik issue 115]
* Changed: Update capture_scripts for WordPress 5.0 but not Gutenberg., [github bobbingwide oik issues 97]
...
* Changed: Updated PHPUnit tests for [bw_countdown] [github bobbingwide oik issues 108]
...
* Fixed: Support for WordPress 5.0 and the new editor - Gutenberg [github bobbingwide oik issues 97]
* Fixed: prevent fatal error in bw_table shortcode [github bobbingwide oik issues 98]
* Fixed: Eliminate Warnings produced when BW_TRANSLATE_DEPRECATED is true [github bobbingwide oik issues 99]
* Fixed: Notices from [paypal] shortcode causes Gutenberg to report Updating failed [github bobbingwide oik issues 101]
* Fixed: bw_wtf - right square bracket displaying as &#093 [github bobbingwide oik issues 102]
* Fixed: bs_jsdate - Notice: Undefined offset leads to Gutenberg Updating failed  [github bobbingwide oik issues 103]
* Fixed: bw_form_field_date enqueuing jquery.ui.datepicker.css from wrong folder [github bobbingwide oik issues 104]
* Fixed: Reduce trace records produced [github bobbingwide oik issues 106]
* Changed: Move trace shortcodes to oik-bwtrace [github bobbingwide oik issues 105]

= 3.2.4 = 
* Changed: Add ids= parameter to [bw_show_googlemap] [github bobbingwide oik issues 94]
* Changed: Improve ad-hoc usage of [bw_twitter] [github bobbingwide oik issues 95]
* Fixed: Support oik-bwtrace v2.1.1 [github bobbingwide oik issues 92]
* Tested: With PHP 7.2
* Tested: With WordPress 4.9.1 

= 3.2.3 =
* Changed: update oik_remote::are_you_local to support testing in WPMS [github bobbingwide oik-libs issues 9]
* Fixed: Cater for old/renamed versions of plugins [github bobbingwide oik issues 80]
* Tested: With PHP 7.0, 7.1 and 7.2 [github bobbingwide oik issues 91]
* Tested: With WordPress 4.9.1 and WordPress Multisite

= 3.2.2 = 
* Changed: Added tag= parameter to [bw_address] shortcode [github bobbingwide oik issues 89]
* Changed: String changes for improved internationalization [github bobbingwide oik issues 9]
* Fixed: Deprecation logic in includes/bw_fields.inc can break a site [github bobbingwide oik issues 90 ]
* Fixed: Unwanted p tags in [bw_address] shortcode [github bobbingwide oik issues 89]
* Tested: With PHP 7.0 and 7.1
* Tested: With WordPress 4.9.1 and WordPress Multisite

= 3.2.1 = 
* Changed: Change caption__example and embed__example for WordPress 4.9 [github bobbingwide oik issues 88]
* Changed: Renamed some .inc files to .php to enable WordPress.org to find translatable strings [github bobbingwide oik issues 9]
* Fixed: Changed some translatable strings and UK English versions of them 
* Fixed: Correct logic to fix warning from dashboard [github bobbingwide oik issues 69]
* Tested: With PHP 7.0 and 7.1
* Tested: With WordPress 4.9 and WordPress Multisite

= 3.2.0 =
* Fixed: Avoid fatal error when  oik_l10n_enable_jti() [github bobbingwide oik issues 9] 
* Fixed: Avoid fatal error when bw_jq_get() not available [github bobbingwide oik issues 68]
* Tested: With PHP 7.0 and 7.1
* Tested: With WordPress 4.9 and WordPress Multisite
...
* Changed: Support shortcode expansion on the HTML code widget [github bobbingwide oik issues 83]
...
* Fixed: Move action hook for 'activate_plugin' to admin [github bobbingwide oik issue 69]
