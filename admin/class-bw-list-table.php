...
class BW_List_Table {
    ...
    //echo "this screen id" . $this->screen->id;
    ...
    echo "prepare_items " . __LINE__ . __FILE__;
		die( 'function BW_List_Table::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	protected function get_items_per_page( $option, $default = 20 ) {
		 ...
		 * 'themes_network_per_page', 'users_network_per_page', 'edit_{$post_type}_per_page', etc.
		 *
		 * @since 2.9.0
		 *
		 * @param int $per_page Number of items to be displayed. Default 20.
		 */
    //bw_trace2( $per_page, "per_page" );
    ...
    //echo "after display_tablenav top";
    //if ( false ) {
...
<?php
    ...
    //echo "display_rows_or_placeholder";
		if ( $this->has_items() ) {
			$this->display_rows();
    ...
    //echo "single_row_columns()";
		list( $columns, $hidden ) = $this->get_column_info();
    

		foreach ( $columns as $column_name => $column_display_name ) {
      //echo PHP_EOL . "$column_name : $column_display_name";
